...
| --- | --- | --- | --- |
| [v1.4.0](releases/v1.4.0.md) | 2026-08-19 | Prepared for publication | Adds forward mapped-trail recovery, precise two-phase maneuver guidance, route cleanup/snapping, correct Back history, and recording map tracking. |
