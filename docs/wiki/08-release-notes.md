...
| --- | --- | --- | --- |
| [v1.3.0](releases/v1.3.0.md) | 2026-07-27 | Prepared | Directional off-route recovery cues, informative voice guidance, and configurable distance/time progress updates. |
