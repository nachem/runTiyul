...
| --- | --- | --- | --- |
| [v1.4.2](releases/v1.4.2.md) | 2026-09-22 | Publication in preparation | Prevents a delayed startup GPS fix from resetting toolbar zoom or current-location recenter; preserves zoom changes while GPS is pending. |
