...
| Automated validation | All 331 local tests, formatting, analysis, and the authorized-DEV debug build passed for v1.4.4. On 2026-09-23, the tagged commit passed hosted CI/CodeQL, signed Android and unsigned iOS builds, publication, and independent checksum/signature/provenance/latest-link checks. No live map-provider requests, device install/field test, or iOS runtime validation occurred. |
