...
| Automated validation | On 2026-09-22, 28 focused map/control tests and 312 full-suite tests passed; 101-file formatting and analysis were clean. v1.4.3 hosted CI, CodeQL, Android/iOS builds, publication, and independent checksum/signature/provenance/latest-link checks passed. No physical-device test was performed. |
