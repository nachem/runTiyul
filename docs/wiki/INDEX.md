...
| Area | Status |
| --- | --- |
| Flutter Android app | Implemented; `1.4.5+15` permanently signed, published, and independently artifact-verified on 2026-09-23, not device-installed. Earlier `1.4.0+10` was installed in place and cold-launched on a Pixel 10; Android 14 emulator verification also exists. |
| Flutter iOS app | Unsigned `1.4.5+15` IPA built and published by macOS CI; checksum and provenance verified, runtime and sideloading unverified |
